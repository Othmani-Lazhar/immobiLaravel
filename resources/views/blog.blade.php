...
<div class="row">
  ...
  <!-- blog list -->
  <div class="row">
                            <div class="col-lg-4 col-sm-4 "><a href="blogdetail.blade.php" class="thumbnail"><img src="images/blog/4.jpg" alt="blog title"></a></div>
...
<!-- blog list -->
  <div class="row">
                            <div class="col-lg-4 col-sm-4 "><a href="blogdetail.blade.php" class="thumbnail"><img src="images/blog/2.jpg" alt="blog title"></a></div>
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.blade.php">Creative business to takeover the market</a></h3>
                            <div class="info">Posted on: Jan 20, 2013</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
  ...
  <!-- blog list -->
  <div class="row">
                            <div class="col-lg-4 col-sm-4 "><a href="blogdetail.blade.php" class="thumbnail"><img src="images/blog/1.jpg" alt="blog title"></a></div>
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.blade.php">Creative business to takeover the market</a></h3>
                            <div class="info">Posted on: Jan 20, 2013</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
  ...
  <!-- blog list -->
  <div class="row">
                            <div class="col-lg-4 col-sm-4 "><a href="blogdetail.blade.php" class="thumbnail"><img src="images/blog/3.jpg" alt="blog title"></a></div>
                            <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.blade.php">Creative business to takeover the market</a></h3>
                            <div class="info">Posted on: Jan 20, 2013</div>                                               
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
