...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="item active">
          <img src="{{asset('img/properties/1.jpg')}}" class="properties" alt="properties" />
        </div>
        <!-- #Item 1 -->

        <!-- Item 2 -->
        <div class="item">
          <img src="{{asset('img/properties/2.jpg')}}" class="properties" alt="properties" />
        ...
        <!-- Item 3 -->
         <div class="item">
          <img src="{{asset('img/properties/3.jpg')}}" class="properties" alt="properties" />
        </div>
        <!-- #Item 3 -->

        <!-- Item 4 -->
        <div class="item ">
          <img src="{{asset('img/properties/4.jpg')}}" class="properties" alt="properties" />
